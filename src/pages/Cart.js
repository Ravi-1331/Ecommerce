...
const Cart = () => {
  ...
  const {cart} = useSelector( (state) => state);  //yaha se cart ka data le liye
  const[totalAmount, setTotalAmount] = useState(0);

  //total Amount nikal gya
  useEffect( () => {
    setTotalAmount(cart.reduce( (acc, curr) => acc + curr.price, 0) );  //setTotalAmount ki value nikal liye or ye tb kiye jb [cart] me kuch add hoga -- or yaha 'reduce' function use ke liye "totalPrice" nikalne ke liye
  },[cart]) 
    ...
    <div>
      {
        ...
        (<div className="max-w-[1200px] mx-auto flex flex-col md:flex-row justify-center">
            ...
            <div div className="w-[100%] md:w-[40%] mt-5  flex flex-col">
